  ...
  render: (args) => (
    <Accordion {...args}>
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tincidunt, nisl nec imperdiet fermentum, nulla
          elit cursus nisl.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          Nulla facilisi. Praesent convallis vel nisi eu pretium. Integer euismod turpis vitae eros pretium tincidunt.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
